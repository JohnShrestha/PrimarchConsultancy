...
class SliderController extends DM_BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        if ($this->model->storeData($request, $request->title, $request->description, $request->image, $request->order, $request->status, $request->rows)) {
