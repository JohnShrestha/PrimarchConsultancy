...
class TypesController extends DM_BaseController
{
    protected $panel = 'Types';
    protected $base_route = 'admin.types';
    protected $view_path = 'admin.types';
    protected $model;
    protected $table;
    ...
    {
       // dd($request->all());
        $data['types'] = Types::create($request->all());
