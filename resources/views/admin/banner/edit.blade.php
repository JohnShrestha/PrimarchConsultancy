                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-body">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="url" name="url" id="url" value="@if(isset($data['rows']->url)) {{ $data['rows']->url   }} @endif" placeholder="Banner url">
                                @if($errors->has('url'))
                            ...
                            <div class="form-group">
                                ...
                                <input class=" form-control" type="number" id="order" min="0" name="order" value="{{ $data['rows']->order   }}">
                            </div>
                            <div class="form-group">
