        ...
        <form action="{{ route('admin.setting.update',  $data['setting']->id )}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label>Fax</label>
                        <input class="form-control" type="text" value="@if(isset($data['setting']->site_fax)) {{ $data['setting']->site_fax }} @else {{ old('site_fax') }} @endif" id="site_fax" name="site_fax" placeholder="मोबाइल नं">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Nepal Office Contact One </label>
                        <textarea name="nepal_office_contact_one" cols="30" rows="5" class="form-control" value="">@if(isset($data['setting']->nepal_office_contact_one)) {{ $data['setting']->nepal_office_contact_one }} @else {{ old('nepal_office_contact_one') }} @endif</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>Nepal Office Contact Two </label>
                        <textarea name="nepal_office_contact_two" cols="30" rows="5" class="form-control" value="">@if(isset($data['setting']->nepal_office_contact_two)) {{ $data['setting']->nepal_office_contact_two }} @else {{ old('nepal_office_contact_two') }} @endif</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>India Office Contact One </label>
                        <textarea name="india_office_contact_one" cols="30" rows="5" class="form-control" value="">@if(isset($data['setting']->india_office_contact_one)) {{ $data['setting']->india_office_contact_one }} @else {{ old('india_office_contact_one') }} @endif</textarea>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label>India Office Contact Two </label>
                        <textarea name="india_office_contact_two" cols="30" rows="5" class="form-control" value="">@if(isset($data['setting']->india_office_contact_two)) {{ $data['setting']->india_office_contact_two }} @else {{ old('india_office_contact_two') }} @endif</textarea>
                    </div>
                </div>
            </div>
