                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="title" id="title" value="{{ old('title') }}" placeholder="Banner Name">
                                @if($errors->has('title'))
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="file" name="image" id="title" value="" placeholder="Image" accept="image/png, image/gif, image/jpeg">
                                @if($errors->has('image'))
                            ...
                            <div class="form-group">
                                ...
                                <input class=" form-control" type="number" min="0" id="order" name="order" value="{{ old('order') }}">
                            </div>
                            <div class="form-group">
                                <label>Status</label>
                                <div class="form-group">
