                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-body">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Language Name">
                                @if($errors->has('name'))
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="code" id="code" value="{{ old('code') }}" placeholder="Language code">
                                @if($errors->has('code'))
                                <p id="name-error" class="help-block " for="site_email"><span>{{ $errors->first('code') }}</span></p>
                                @endif
                            </div>
                            <div class="form-group">
