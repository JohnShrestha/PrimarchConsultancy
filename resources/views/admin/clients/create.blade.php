                        ...
                        <div class="ibox-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" type="text" name="name" id="name" value="{{ old('name') }}" placeholder="Client Name">
                                    @if($errors->has('name'))
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" type="url" name="url" id="url" value="{{ old('url') }}" placeholder="Clients Link">
                                    @if($errors->has('url'))
