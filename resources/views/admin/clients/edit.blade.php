                        ...
                        <div class="ibox-body">
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" type="text" name="name" id="name" value="@if(isset($data['rows']->name)) {{ $data['rows']->name   }} @endif" placeholder="Client Name">
                                    @if($errors->has('name'))
                                    <p id="name-error" class="help-block " for="site_email"><span>{{ $errors->first('name') }}</span></p>
                                    @endif
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="url">Client Link</label>
                                    <input class="form-control" type="url" name="url" id="url" value="@if(isset($data['rows']->url)) {{ $data['rows']->url   }} @endif" placeholder="Client url">
                                    @if($errors->has('url'))
